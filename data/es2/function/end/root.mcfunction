...
tellraw @a ["<", {"text": "強化空島戰爭 Lite", "color": "aqua"}, "> ", {"text": "點我重設地圖", "color": "yellow", "clickEvent": {"action": "run_command", "value": "/execute if score #time time matches -2 run function es2:end/reset/begin"}}]
