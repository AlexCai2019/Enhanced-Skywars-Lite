...
execute store result storage es2:data root.before.information.team int 1 positioned ~-1.5 33.0 ~-4.5 if entity @e[type=marker, tag=choose_team, scores={survive=1}, dx=5, dy=0, dz=0]
...
#真實時間
execute positioned ~ 319 ~ run function es2:before/second/real_time
